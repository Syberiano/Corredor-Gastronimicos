...
function actualizarMapa() {
    let ubicaciones = {
        1: { lat: 6.2085, lng: -75.5670 }, 
        2: { lat: 6.1759, lng: -75.5917 }, 
        3: { lat: 6.1516, lng: -75.6152 },
        4: { lat: 6.1578, lng: -75.6353 }, 
        5: { lat: 6.1691, lng: -75.6114 }, 
        6: { lat: 6.3373, lng: -75.5610 }, 
        7: { lat: 6.3467, lng: -75.4357 }, 
        8: { lat: 6.4378, lng: -75.3341 }, 
        9: { lat: 6.3753, lng: -75.4444 }, 
        10: { lat: 6.0329, lng: -75.6344 }, 
        11: { lat: 6.2442, lng: -75.5812 } 
    };

   
    let linkMapaPoblado = document.getElementById("mapaPoblado");
    if (linkMapaPoblado) {
        linkMapaPoblado.addEventListener("click", () => {
            document.getElementById("buscar_zona").value = "1"; 
        });
    }
